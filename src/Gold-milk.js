...
import { questions5 } from './API/accordianapi'

export const Gold_milk = () => {
    const [data, setData] = useState(questions5);
    return (
        <>
           <section className="product-detail gold-milk">
                <div className="container">            
                <div className="product-container">                            
                    <div className="row">
                        <div className="col-md-5">
                                <div className="produ_img" data-aos="fade-left" data-aos-delay="500" data-aos-once="true" data-aos-duration="1000">
                                    <img src="./images/gold-milk.png" alt="" />
                                 </div>
                                 </div>
            ...
            <section className="accordians goldmilk">
                <div className="container">
                    <div className="product-container"> 
