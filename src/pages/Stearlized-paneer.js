...
import { questions14 } from '../API/accordianapi';
...
export const Stearlizedpaneer = () => {
    const [data, setData] = useState(questions14);
    useEffect(() => {
